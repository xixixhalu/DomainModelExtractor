...
class UMLAssociation:
    def __init__(self, entity_one, entity_two, association_type='default', msg='', multiplicity='one_to_one'):
    ...
    def association(self, association_type='association', msg='', multiplicity='one_to_one'):
        type_switcher = {
            "default": " -- ",
            "generalization": " <|-- ",
            "composition": " *-- ",
    ...
    def output(self):
        rst = self.__entity_one + \
                self.association(self.__association_type, self.__multiplicity) + \
                self.__entity_two

        if self.__msg != '':
            rst += ' : ' + self.__msg.strip()
...
class UMLViewer:
    ...
    def add_association(self, association):
        if not association.entity_one() in self.__entity_map:
            self.add_entity(association.entity_one())
        if not association.entity_two() in self.__entity_map:
            self.add_entity(association.entity_two())
